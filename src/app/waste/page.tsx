...
export default function WastePage() {
  return (
    <main className="container mx-auto space-y-12 p-6">
      ...
      <section>
        <h2 className="text-3xl font-bold mb-6">Licensed Waste Collectors</h2>
      ...
      <section>
        <Card>
          <CardHeader>
            <CardTitle>Official Public Schedule</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
              ...
              <TableBody>
                {collectionSchedule.map((s) => (
                  <TableRow key={s.area}>
                    <TableCell className="font-semibold">{s.area}</TableCell>
