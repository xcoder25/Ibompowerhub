...
export function StepSellerType({ data, updateData, onNext, onPrev, onSaveDraft, savingDraft }: StepProps) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
        ...
        {SELLER_TYPES.map((type) => {
          ...
          return (
            <div
              ...
              className={cn(
                "p-4 rounded-2xl border text-left cursor-pointer transition-all duration-200 relative group flex flex-col justify-between select-none",
                isSelected
      ...
      <div className="bg-slate-50 dark:bg-slate-900/40 p-4 rounded-2xl border border-slate-200/70 dark:border-slate-800 flex items-center justify-between">
